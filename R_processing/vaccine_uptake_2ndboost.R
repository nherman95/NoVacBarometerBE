...
# endpoint uptake
endpoint_uptake <- as.Date('2023-07-01')
...
#endpoint_reported_data <- as.Date('2022-05-21')
...
scen_out_final <- scen_out_2ndbooster
...
legend('topleft',
       c('Uptake: total',
         ...
         'Model: 1st dose',
         'Model: 2nd dose'),
       col=c(1,4,5,7,2,NA,8,8,8,8,8,8),
       lty=c(1,1,1,1,1,NA,NA,NA,NA,NA,1,3),
       pch=c(NA,NA,NA,NA,NA,NA,1,3,6,9,NA,NA),
       lwd=2,
       xpd=TRUE,
       cex=1.1)
...
#          '',
#          paste0('End 2ndbooster campaign: ',timing_booster_finished)
#          ),
